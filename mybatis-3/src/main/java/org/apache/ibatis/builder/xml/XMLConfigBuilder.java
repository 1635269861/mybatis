...
public class XMLConfigBuilder extends BaseBuilder {
  ...
  private void parseConfiguration(XNode root) {
    try {
      ...
      // 解析配置文件中的Mapper节点，在这里会将每个Mapper中的Select、update、insert、delete等语句解析成MappedStatement
      // MyBatis通过MappedStatement类来描述Mapper的SQL配置信息（将Mapper.xml中的每个sql节点都封装成一个MappedStatement）
